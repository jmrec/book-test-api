...
public record BookUpdateRequest(@NotNull(message = "Id is required") UUID id,
        @NotBlank(message = "Author is required") String author, @NotBlank(message = "Title is required") String title,
